...
public class CustomerHomeFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View v = inflater.inflate(R.layout.fragment_customerhome, container, false); // Utilisez false au lieu de null
                    ...
                    public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                        ...
                        if (cust != null) {
                            ...
                            if (State != null && City != null && Sub != null) {
                                ...
                                // Handle the case where State, City, or Sub is null
                            }
                        } else {
                            swipeRefreshLayout.setRefreshing(false);
                            // Handle the case where Customer data is null
                        }
                    }
